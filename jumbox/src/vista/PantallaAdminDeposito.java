...
public class PantallaAdminDeposito extends JFrame {
	...
	public PantallaAdminDeposito(String mail) {
		...
		btnRegistrarSalida.setBounds(96, 163, 156, 33);
		...
		btnConfirmarSolicitud.setBounds(321, 163, 265, 33);
		...
		btnConfirmarSolicitud.addActionListener(e -> {
			PantallaConfirmarSolicitudDePedido pantallaConfirmarSolicitudDePedido = new PantallaConfirmarSolicitudDePedido(
					mail, idPedido);
